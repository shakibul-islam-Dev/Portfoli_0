const ReactIcon = ({ size = 40, className = "" }) => {
  return (
    <>
      <style>
        {`
          @keyframes rotate-react-gradient {
          ...
          /* React Official Blue Gradient */
          .react-gradient-wrapper::before {
            content: '';
            position: absolute;
            width: 150%;
            height: 150%;
            ...
            animation: rotate-react-gradient 4s linear infinite;
            z-index: -2;
          }

          .react-gradient-wrapper::after {
            content: '';
            position: absolute;
            inset: 4px;
            background: white;
          ...
          /* Real Atom Animation Logic */
          .react-logo-inner {
            transition: all 0.3s ease;
          }

          /* Hover korle pura logo-ta slow ghurbe */
          .react-gradient-wrapper:hover .react-logo-inner {
            animation: atom-spin 10s linear infinite;
          }

          /* React paths animation on hover */
          .react-gradient-wrapper:hover svg path:first-child {
      ...
      <div
        className={`react-gradient-wrapper ${className}`}
        style={{ width: size, height: size }}
      >
        <div
          className="react-logo-inner"
          style={{
            width: "70%",
            height: "70%",
            display: "flex",
